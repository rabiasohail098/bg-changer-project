     ...
     <div className="w-full h-screen duration-200"
      ...
      >
        <div className="fixed flex flex-wrap justify-center bottom-12 inset-x-0 px-2">
          <div className="flex flex-wrap justify-center gap-3  shadow-lg bg-slate-400 px-2 py-2 rounded-3xl">
            ...
            <button  onClick = {()=>setColor("plum")} className="outline-none px-4 py-1 rounded-full text-black shadow-lg"  style={{backgroundColor:"plum"}}>Plum</button>
